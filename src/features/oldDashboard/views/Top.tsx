        ...
        for (let i = 0; i < teamsLength; i += 1) {
            ...
            $teams.push(
                <li className="informatonBoard-projects-item " key={i}>
                    <Link
                        to={`/project/${String(team?.id)}`}
                        className="informatonBoard-projects-item-body"
                    >
                        <p className="informatonBoard-projects-item-title">
                            {team?.name}
                        </p>
                        <p className="informatonBoard-projects-item-description">
                            {team?.description}
                        </p>
                    </Link>
                </li>
                ...
                <div className="informatonBoard">
                    <div className="informatonBoard-body">
                        <div className="informatonBoard-projects">
                            <div className="informatonBoard-projects-title">
                                <FontAwesomeIcon
                                    className="icon"
                                    icon={faNoteSticky}
                                />{' '}
                                <p className="text">プロジェクト</p>
                            </div>
                            <ul className="informatonBoard-projects-list">
                                ...
                                <li className="informatonBoard-projects-item">
                                    <button
                                        type="button"
                                        className="informatonBoard-projects-item-body create"
                        ...
                        <div className="informatonBoard-teams">
                            <p className="informatonBoard-teams-title">
                                チーム
                            </p>
